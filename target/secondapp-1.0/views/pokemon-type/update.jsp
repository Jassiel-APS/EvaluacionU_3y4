...
<html>
<head>
    <title>Actualizar tipo de pokémon</title>
...
<div class="container">
    <div class="row">
        <div class="col">
            <h2 class="mt-3 mb-5">EDICIÓN DE TIPO DE POKÉMON</h2>
            <div class="card">
                ...
                <div class="card-body">
                    <form id="typeForm" action="/api/type/update" method="post" class="needs-validation" novalidate>
                        <div class="row form-row form-group">
                            <input hidden name="id" value="${type.id}">
                            <div class="col mb-3">
                                <label for="description" class="fw-bold">Descripción</label>
                                <input type="text" value="${type.description}" class="form-control" name="description" id="description"/>
                            </div>
                        </div>
                        <div class="row form-row form-group mb-3">
                            <div class="col text-end">
                                ...
                                <button id="btnTypeForm" onclick="sendForm()" type="button"
                                    ...
                                    <i data-feather="check"></i> ACTUALIZAR
                                </button>
                            </div>
                        </div>
                    </form>
