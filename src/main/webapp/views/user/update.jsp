...
<html>
<head>
    <title>PK | Actualizar usuario</title>
    ...
    <div class="row">
        <div class="col">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form id="userForm" action="/api/people/update" novalidate method="post" class="needs-validation">
                        <div class="form-group row form-row mb-3">
                            <div class="col">
                                <label class="fw-bold" for="name">Nombre</label>
                                <input hidden name="id" value="${user.id}" required/>
                                <input hidden name="id" value="${user.person.id}" required/>
                        ...
                        <div class="form-group row form-row mb-3">
                            ...
                            <div class="col">
                                ...
                                <select id="role" name="role" class="form-select" required value="${user.role.id}">
                        ...
                        <div class="form-group row form-row">
                            <div class="col text-end">
                                ...
                                <button id="userFormBtn" onclick="sendForm()" type="button"
